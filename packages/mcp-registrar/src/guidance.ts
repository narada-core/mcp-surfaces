...
export function buildGuidanceResult(args: GuidanceRecord = {}): GuidanceRecord {
  ...
  return {
    ...
    tool_preference: [
      ...
      { step: 'materialize_carriers', guidance: 'Call registrar_materialize_all to rewrite every registered carrier config together and refresh registrar-owned Site projection fragments before their registries are regenerated. Normal materialization never takes a carrier_id.' },
    ...
    recovery: [
      ...
      'For PATH-relative node or bun commands in registrar-owned Site fragments, run canonical all-carrier materialization; it refreshes only fragments explicitly marked as Registrar generated and reports skipped source-owned files.',
