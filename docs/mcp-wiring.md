...
extension at `~/.pi/agent/extensions/narada-mcp/index.ts`. It eagerly starts only `mcp-loader`. All other Site capabilities, including
Task Lifecycle, are attached lazily through Loader. Other admitted Site authority remains
