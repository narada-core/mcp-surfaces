...
| `mailbox` | Rust-native default | The native shared surface owns the bounded mailbox projection contract and exposes synchronization authority explicitly; the native profile selects Rust and Node remains an opt-in rollback. |
